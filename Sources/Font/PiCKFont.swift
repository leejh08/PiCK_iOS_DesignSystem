...
public extension SwiftUI.Font {
    static func pickFont(_ font: PiCKFontStyle) -> SwiftUI.Font {
        let uiFont = font.uiFont()
        return SwiftUI.Font.custom(uiFont.fontName, size: font.size())
    }
}

public extension PiCKFontStyle {
    internal func uiFont() -> UIFont {
