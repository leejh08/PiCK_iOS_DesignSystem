...
/// Since PiCK_iOS_DesignSystem is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "PiCK_iOS_DesignSystem_PiCK_iOS_DesignSystem"
    var candidates = [
    ...
    fatalError("unable to find bundle named PiCK_iOS_DesignSystem_PiCK_iOS_DesignSystem")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class PiCKIOSDesignSystemResources: NSObject {
